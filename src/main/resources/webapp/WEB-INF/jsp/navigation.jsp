...
<ul class="nav nav-tabs">
  ...
  <li<c:if test="${param.activeTab == 'dynamic'}"> class="active"</c:if>><a href="<c:choose><c:when test="${param.activeTab == 'dynamic'}">#</c:when><c:otherwise><c:url value="/dynamic.html"/></c:otherwise></c:choose>">Dynamic AJAX Form</a></li>
</ul>